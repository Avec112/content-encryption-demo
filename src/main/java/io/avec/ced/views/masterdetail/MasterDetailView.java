package io.avec.ced.views.masterdetail;
...
import io.avec.ced.data.service.SamplePersonService;
...
@PageTitle("Sample Person")
@Route(value = "sample-person/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed({"user", "ROLE_admin"})
@Uses(Icon.class)
public class MasterDetailView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "sample-person/%d/edit";
